...
object KPI5_2 {
  def main(args: Array[String]){
    ...
    val res3 = spark.sql("select t1._c3 state ,t1._c4 district, sum(t1._c9) r_sum from Tab1 t1, Tab2 t2 where t1._c3 = t2._c3 and t1._c7='F' group by t1._c3,t1._c4")
    ...
    res4.rdd.coalesce(1, true)saveAsTextFile("/home/hduser/eclipse-workspace/AadharProject/kp52outDF")
