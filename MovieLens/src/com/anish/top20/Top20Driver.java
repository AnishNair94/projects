...
public static void main(String[] args) throws Exception {
    ...
    if (otherArgs.length != 4) {
      System.err.println("Usage: top20 <in> <in> <out> <out>");
      System.exit(2);
    }
...
job2.setJarByClass(Top20Driver.class);
...
job2.setMapperClass(Top20Mapper.class);
job2.setReducerClass(Top20Reducer.class);
